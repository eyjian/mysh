...
func backtickCommands() []Suggestion {
	return []Suggestion{
		...
		{Text: "\\clear", Type: SuggestKeyword, Detail: "clear screen"},
		{Text: "\\status", Type: SuggestKeyword, Detail: "show connection status"},
		{Text: "\\use", Type: SuggestKeyword, Detail: "switch database"},
		{Text: "\\l", Type: SuggestKeyword, Detail: "list databases"},
		{Text: "\\dt", Type: SuggestKeyword, Detail: "list tables"},
		{Text: "\\di", Type: SuggestKeyword, Detail: "list indexes"},
		{Text: "\\dv", Type: SuggestKeyword, Detail: "list views"},
		{Text: "\\dn", Type: SuggestKeyword, Detail: "list schemas"},
		{Text: "\\du", Type: SuggestKeyword, Detail: "list users"},
		{Text: "\\echo", Type: SuggestKeyword, Detail: "echo text"},
		{Text: "\\conninfo", Type: SuggestKeyword, Detail: "show connection info"},
		{Text: "\\x", Type: SuggestKeyword, Detail: "toggle expanded output"},
		{Text: "\\connect", Type: SuggestKeyword, Detail: "connect to database"},
		{Text: "\\reconnect", Type: SuggestKeyword, Detail: "reconnect to server"},
		...
		{Text: "\\pset", Type: SuggestKeyword, Detail: "output format details"},
		{Text: "\\history", Type: SuggestKeyword, Detail: "search history"},
		{Text: "\\source", Type: SuggestKeyword, Detail: "execute SQL file"},
		{Text: "\\edit", Type: SuggestKeyword, Detail: "open editor"},
		{Text: "\\desc", Type: SuggestKeyword, Detail: "describe table"},
		{Text: "\\sf", Type: SuggestKeyword, Detail: "show function"},
		{Text: "\\privileges", Type: SuggestKeyword, Detail: "show table privileges"},
		{Text: "\\export", Type: SuggestKeyword, Detail: "export result to file"},
		{Text: "\\g", Type: SuggestKeyword, Detail: "execute and save"},
		{Text: "\\gx", Type: SuggestKeyword, Detail: "execute vertical"},
		{Text: "\\explain", Type: SuggestKeyword, Detail: "explain query plan"},
		{Text: "\\watch", Type: SuggestKeyword, Detail: "watch query at intervals"},
		{Text: "\\timing", Type: SuggestKeyword, Detail: "toggle timing display"},
		{Text: "\\set", Type: SuggestKeyword, Detail: "set session variable"},
		{Text: "\\get", Type: SuggestKeyword, Detail: "get session variable"},
		{Text: "\\unset", Type: SuggestKeyword, Detail: "unset session variable"},
		{Text: "\\prompt", Type: SuggestKeyword, Detail: "prompt for input"},
		{Text: "\\encoding", Type: SuggestKeyword, Detail: "show/set encoding"},
		{Text: "\\verbose", Type: SuggestKeyword, Detail: "toggle verbose mode"},
		{Text: "\\warn", Type: SuggestKeyword, Detail: "toggle warnings"},
		{Text: "\\alias", Type: SuggestKeyword, Detail: "manage SQL aliases"},
		{Text: "\\session", Type: SuggestKeyword, Detail: "manage sessions"},
		{Text: "\\fav", Type: SuggestKeyword, Detail: "manage favorite queries"},
		{Text: "\\copy", Type: SuggestKeyword, Detail: "copy to clipboard"},
		{Text: "\\pipe", Type: SuggestKeyword, Detail: "pipe result to command"},
		{Text: "\\sys", Type: SuggestKeyword, Detail: "execute system command"},
		{Text: "\\rollback", Type: SuggestKeyword, Detail: "rollback transaction"},
		{Text: "\\T", Type: SuggestKeyword, Detail: "set result title"},
	}
}
